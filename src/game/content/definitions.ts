...
export const ENEMY_DEFINITIONS: Record<EnemyKind, EnemyDefinition> = {
  slime: {
    ...
    damage: 8, xp: 5, scale: 1.35, bodyRadius: 9, firstWave: 1, color: 0x8edb75,
  },
  goblin: {
    kind: 'goblin', name: 'Briar Goblin', texture: 'enemy-goblin', hp: 27, speed: 88,
    damage: 9, xp: 6, scale: 1.3, bodyRadius: 8, firstWave: 2, color: 0xc4de6a,
  },
  bat: {
    kind: 'bat', name: 'Dusk Bat', texture: 'enemy-bat', hp: 19, speed: 126,
    damage: 7, xp: 5, scale: 1.25, bodyRadius: 7, firstWave: 3, color: 0xb8a2df,
  },
  skeleton: {
    kind: 'skeleton', name: 'Rootbound Skeleton', texture: 'enemy-skeleton', hp: 42, speed: 66,
    damage: 9, xp: 8, scale: 1.35, bodyRadius: 8, firstWave: 4, color: 0xeee1b8,
  },
  wolf: {
    kind: 'wolf', name: 'Thorn Wolf', texture: 'enemy-wolf', hp: 48, speed: 96,
    damage: 11, xp: 9, scale: 1.4, bodyRadius: 9, firstWave: 5, color: 0xb8c8bb,
  },
  spider: { kind: 'spider', name: 'Gloom Spider', texture: 'enemy-spider', hp: 46, speed: 82, damage: 9, xp: 10, scale: 1.28, bodyRadius: 8, firstWave: 2, color: 0x9d72c5 },
  zombie: { kind: 'zombie', name: 'Rotwalker', texture: 'enemy-zombie', hp: 92, speed: 43, damage: 12, xp: 15, scale: 1.42, bodyRadius: 10, firstWave: 3, color: 0x7eaa70 },
  mushroom: { kind: 'mushroom', name: 'Sporecap', texture: 'enemy-mushroom', hp: 52, speed: 48, damage: 9, xp: 11, scale: 1.35, bodyRadius: 9, firstWave: 1, color: 0xd887ad },
  plant: { kind: 'plant', name: 'Living Briar', texture: 'enemy-plant', hp: 78, speed: 24, damage: 13, xp: 15, scale: 1.4, bodyRadius: 10, firstWave: 4, color: 0x5fbd62 },
  darkKnight: { kind: 'darkKnight', name: 'Dark Knight', texture: 'enemy-darkKnight', hp: 130, speed: 62, damage: 15, xp: 21, scale: 1.42, bodyRadius: 10, firstWave: 6, color: 0x66708d },
  lizardman: { kind: 'lizardman', name: 'Scalehunter', texture: 'enemy-lizardman', hp: 86, speed: 84, damage: 12, xp: 17, scale: 1.38, bodyRadius: 9, firstWave: 4, color: 0x74b35c },
  witch: { kind: 'witch', name: 'Blood Witch', texture: 'enemy-witch', hp: 68, speed: 76, damage: 12, xp: 19, scale: 1.38, bodyRadius: 9, firstWave: 6, color: 0xc26da5 },
};
